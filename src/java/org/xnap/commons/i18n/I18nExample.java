...
/**
 * This example class illustrates how the methods provided by {@link i18n} can
 * be used to localize text messages. Nota bene: Contrary to this example
 * changing the resources during run-time is usually not a good idea, since most
 * strings are saved in the swing components and not reread from resource
 * bundles.
 * 
 * @author Felix Berger
 */
