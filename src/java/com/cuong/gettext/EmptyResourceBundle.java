...
/**
 * A <code>ResourceBundle</code> that returns the key as a value. FIXME needs to
 * implement proper plural handling FIXME the bundle needs to have a valid
 * locale for proper sourceCodeLocale handling
 */
